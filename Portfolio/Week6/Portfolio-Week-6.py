...
# 1.Write a function that accepts a positive integer as a parameter and then returns representation of that number in binary (base 2).
...
# Function Testing
positive_integer = 42
binary_representation = dec_to_bin(positive_integer)
...
print(f"The factors of {integer} are: {result}")
print()
